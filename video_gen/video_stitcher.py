    ...
    def _concat_and_trim(self, clip_paths: list[str], output_path: str) -> str | None:
        ...
        try:
            ...
            cmd_trim = [
                ...
                "-i", str(temp_concat),
                "-t", str(TARGET_DURATION),
                "-vf", f"fade=t=in:st=0:d=0.3,fade=t=out:st={TARGET_DURATION - 0.3}:d=0.3",
                "-af", f"loudnorm=I=-14:TP=-1:LRA=11,afade=t=in:st=0:d=0.3,afade=t=out:st={TARGET_DURATION - 0.3}:d=0.3",
                "-c:v", "libx264",
                "-c:a", "aac",
                "-b:a", "192k",
                "-ar", "48000",
