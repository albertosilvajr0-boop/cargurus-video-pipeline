...
class VeoGenerator:
    ...
    async def generate_clip(
        ...
        if not self.cost_tracker.can_afford("veo", self.quality):
            console.print("[yellow]Budget exceeded — cannot generate Veo clip[/yellow]")
            return None
        ...
        try:
            ...
            console.print(f"[red]Veo generation failed: {e}[/red]")
            return None
    ...
    async def _generate(
        ...
        while not operation.done:
            if time.time() - start > max_wait:
                console.print("[red]Veo generation timed out (5 min)[/red]")
                return None
        ...
        console.print("[red]No video generated by Veo[/red]")
        return None
